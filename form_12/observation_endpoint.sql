...
avys as (
    ...
    ,struct(
        ...
        REGEXP_EXTRACT(destructive_size, r'\w+') as destructive_size,
        REGEXP_EXTRACT(relative_size, r'\w+') as relative_size,
    ...
    ,struct(
        ...
        REGEXP_EXTRACT(destructive_size_1, r'\w+') as destructive_size,
        REGEXP_EXTRACT(relative_size_1, r'\w+') as relative_size,
        ...
        REGEXP_EXTRACT(destructive_size_2, r'\w+') as destructive_size,
        REGEXP_EXTRACT(relative_size_2, r'\w+') as relative_size,
        ...
        REGEXP_EXTRACT(destructive_size_3, r'\w+') as destructive_size,
        REGEXP_EXTRACT(relative_size_3, r'\w+') as relative_size,
        ...
        REGEXP_EXTRACT(destructive_size_4, r'\w+') as destructive_size,
        REGEXP_EXTRACT(relative_size_4, r'\w+') as relative_size,
